...
public class XY {
	...
	public XY(int month,int day,int  terminalDay) throws FileNotFoundException {
		int KSJC = 0, JSJC = 0;
		String date,data;
		...
		while (day <= terminalDay) {
			...
			time = 0;
			int colorNumber = 0;
			printWriter = new PrintWriter(new File("C:/Users/1/Desktop/空教室数据/1/1"+month + day + ".json"));
			printWriter.print("[");
