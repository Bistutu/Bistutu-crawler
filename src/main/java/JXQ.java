...
public class JXQ {
	...
	public JXQ(int month,int day,int terminalDay) throws Exception {
		int KSJC=0,JSJC=0;
		String date,data;
		...
		while (day <= terminalDay) {
			...
			time = 0;
			int colorNumber=0;
			printWriter = new PrintWriter(new File(Path.getPath()+"/2/2"+month + day + ".json"));
			printWriter.print("[");
...
//		XXXQDM=2&JASLXDM=02&KXRQ=2021-11-18&KSJC=1&JSJC=5
